...
function NavbarCitizen() {
  return (
    ...
    <a href="#" className='text-[#FFFF] hover:bg-gray-700 hover:text-[#FFFF] hover:font-bold hover:rounded px-2 py-1'>Complaints</a> 
    <a href="#" className='text-[#FFFF] hover:bg-gray-700 hover:text-[#FFFF] hover:font-bold hover:rounded px-2 py-1'>Notes</a> 
